...
public class Des {
	 ...
	 * 前n-1组使用单长密钥DES CBC算法（使用密钥是密钥的左8字节）
	 * 最后1组使用双长密钥3DES CBC算法（使用全部16字节密钥）
	 * @param key密钥(32byte)
	 * @param vector初始向量0000000000000000
	 * @param data数据
	 * @return mac
	...
	public static String PBOC_ECB_MAC(String key, String vector, String data, int type) {
		if (key.length()!=16){
			return null;
		}
		if (type == ASC) {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(PBOC_DES_MAC("46AB910E2F54DA25", 
				"0000000000000000", 
				"02007020048000C080111645181111222233331000010000000100031234560210007431303030303036733130303030303531343530313337313536001422000001000501",
				HEX));
	}
}
